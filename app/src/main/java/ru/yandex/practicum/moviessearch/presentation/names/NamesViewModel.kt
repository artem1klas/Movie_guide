...
class NamesViewModel(private val context: Context,
    ...
    private fun searchRequest(newSearchTextString: String) {
        if (newSearchTextString.isNotEmpty()){
            renderState(NamesState.Loading)

            namesInteractor.searchNames(newSearchTextString, object : NamesInteractor.NamesConsumer{
